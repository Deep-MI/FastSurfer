...
def make_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--title", "-t", type=str, dest="title", help="value for the title of the distribution file", required=True
    )
    return parser
...
def edit_distribution(distribution_file: Path | str, title: str) -> None:
    ...
    # generated by build_release_package.sh from conclusion.html.template; HTML (rather than plain
    # text), so the installer renders it properly and its links are clickable
    conclusion_tag.attrib["file"] = "conclusion.html"
    conclusion_tag.attrib["mime-type"] = "text/html"
