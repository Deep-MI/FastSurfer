...
FastSurfer is an open-source AI software tool to extract quantitative measurements from human brain MRI (T1-weighted) images.
...
* FastSurfer uses dedicated and fast AI methods (developed by `Deep-MI <https://deep-mi.org>`_).
* It is thoroughly validated across different scanners, field-strengths, T1 sequences, ages, diseases, ...
...
* It includes an experimental lesion inpainting tool (LIT) for robust processing of brains with tumors or abnormalities.
