...
from CCNet.utils.logging import getLogger as _getLogger
...
class Zoom2d(_ZoomNd):
    ...
    def _interpolate(
        ...
        Args:
            data: input, to-be-interpolated tensor
...
class Zoom3d(_ZoomNd):
    ...
    def _interpolate(self, data: Tensor, scale_factor: _T.Union[Tensor, np.ndarray, _T.Sequence[int]]):
        """
