...
def main(
    ...
    from CCNet.utils.run_tools import Popen, PyPopen
...
def filter_git_status(git_process: 'CCNet.utils.run_tools.Popen') -> str:
    """
    Takes a running git status process and filters the output.

    Parameters
    ----------
    git_process : CCNet.utils.run_tools.Popen
    ...
    """
    from CCNet.utils.run_tools import Popen
