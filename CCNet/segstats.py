...
from CCNet.utils.parser_defaults import add_arguments
from CCNet.utils.arg_types import (int_gt_zero as patch_size, int_ge_zero as id_type,
...
def main(args):
    ...
    from CCNet.utils.common import assert_no_root
    ...
    if any(getattr(args, n, '') != '' for n in names):
        ...
        for n, v, dtype in zip(names, var_names, dtypes):
            ...
            try:
                ...
                from CCNet.data_loader.data_utils import save_image
...
if __name__ == "__main__":
    # full timeit cmd arg
    # python -m timeit "from CCNet.segstats import main, make_arguments; \
