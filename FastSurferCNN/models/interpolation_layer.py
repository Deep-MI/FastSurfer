...
class _ZoomNd(nn.Module):
    ...
    def __init__(
        ...
        Args:
            target_shape: Target tensor size for after this module,
                                             not including batchsize and channels.
    ...
    def forward(
        ...
        Args:
            ...
            rescale: Whether to rescale. Defaults to false
        Returns:
    ...
    def _fix_scale_factors(
        ...
        Args:
            scale_factors: scale factors to fix dimensions
...
class Zoom2d(_ZoomNd):
    ...
    Attributes:
        _N: Number of dimensions (Here 2)
    ...
    def __init__(
        ...
        Args:
            target_shape: Target tensor size for after this module, not including batchsize and channels.
...
class Zoom3d(_ZoomNd):
    ...
    Attributes:
        _N: Number of dimensions (Here 3)
        _crop_position: Crop postion
