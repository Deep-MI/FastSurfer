...
from CerebNet.utils.checkpoint import CEREBNET_AXI, CEREBNET_COR, CEREBNET_SAG, URL as CEREBNET_URL
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cerebnet", default=False, action="store_true",
    ...
    if args.vinn or args.all:
        get_checkpoints(VINN_AXI, VINN_COR, VINN_SAG, URL if args.url is None else args.url)
